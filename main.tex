...
The glial markers were selected referring review articles, and the tagged GO terms were querried using mygene.py. 
Then, all gene symbols subscribed with each GO terms were querried again. The visualization was implemented 
