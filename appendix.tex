...
\begin{figure}[htb]
  ...
  \legend{
    ...
    \textbf{E}: Kernel density estimation of the coverage values in the clusters 5 and 8 of PBMC3k.
    \textbf{F}: Results of OT-based domain adaptation converting 
    the source distribution (the cluster 5) to the target distribution (the cluster 8).
    \textbf{G}: Correlation coefficients of the coverage values in the source distribution (the cluster 5), 
    the transformed distribution (the cluster 5 mapped by the OT model), and the target distribution (the cluster 8).
