...
\begin{figure}[htb]
  ...
  \legend{
    \textbf{A}: The ROC curves visualizing the prediction performances of the clusters 0$\sim$8 and their macro average
    \textbf{B}: The PR curves visualizing the prediction performances of the clusters 0$\sim$8 and their micro average
